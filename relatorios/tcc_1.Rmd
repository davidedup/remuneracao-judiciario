...
dados_juntos %>% 
  ...
  geom_boxplot() +
  theme_minimal() +
  scale_y_log10(labels = scales::comma, breaks=c(1050, 3000, 5000, 10000, 15000, 20000, 35000, 50000, 65000,80000, 150000, 300000, 500000, 750000, 1000000, 1500000, 6000000)) +
  theme(legend.position = "none", text = element_text(size=12)) +
